...
#   Y        valido si el usuario aplica para upfront
   ...
   #Y        ingreso los datos de agendamiento
    ...
    Ejemplos:
      ...
      | usuario externo | evillanuevag | $Telefonica2020$ | Bienvenid@ | Bienvenid@   | RUC           | 20547284501 | 1   | DNI             | 75447652       | ANALY FLORES LOPEZ| 15           | 1501      | 150116   | Jiron Julio Cesar Tello 460 | A          | Trío     | TRÍO MOV. VOZ INTERNET ESTANDAR HD RA D22 150 MBPS | discapacitado  | TRÍO MOV. VOZ INTERNET ESTANDAR HD RA D22 150 MBPS |
