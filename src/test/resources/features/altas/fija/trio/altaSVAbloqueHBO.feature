...
#    Y        valido el detalle de la seleccion
    ...
    Ejemplos:
      ...
      | usuario externo | nishuizas | $T3l3f0n1c4$| Bienvenid@ | CAJAMARCA    | CE            | 122210228 | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 469 | PISO 1     | MOVISTAR TOTAL | TRÍO MOV. VOZ INTERNET ESTANDAR HD  | HBO    | correo@gmail.com |
