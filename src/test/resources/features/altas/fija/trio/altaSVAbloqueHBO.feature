...
#    Y        valido el detalle de la seleccion
    ...
    Ejemplos:
      ...
      | usuario externo | evillanuevag | $Telefonica2020$ | Bienvenid@ | CAJAMARCA    | CE            | 122210228 | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 460 | PISO 1     | MOVISTAR TOTAL | TRÍO MOV. VOZ INTERNET ESTANDAR HD  | HBO    | correo@gmail.com |
