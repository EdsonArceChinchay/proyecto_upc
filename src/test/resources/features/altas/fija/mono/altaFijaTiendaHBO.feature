#language:es
@BERSERKERS @DoneDevOps @DoneDevOpsPI11 @DROP35_Upfront
...
#	Cuando   doy clic a iniciar registro
    ...
    Ejemplos:
      ...
      | usuario externo | lterrazosce | Telefonica2021 | Bienvenid@ | CAJAMARCA    | CE            | 1042464879 | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 460 | INKAFARMA  | Mono     | INTERNET MOVISTAR RA D22 100 | discapacitado  | MARINA      | MARCIAL     | HUARMACA    | TV Estándar Digital | PACK ANTIVIRUS MCAFEE |
