...
Característica: Alta Duo por tienda
  ...
  Esquema del escenario: Alta Duo por tienda con Nuevo Cliente Extranjero
    ...
    Ejemplos:
      ...
      | usuario externo | lterrazosce | Telefonica2021 | Bienvenid@ | CE            | 1002000241 | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 460 | Casa       | Duo        | Dúo Movistar Voz Internet RA D22 1000 Mbps |