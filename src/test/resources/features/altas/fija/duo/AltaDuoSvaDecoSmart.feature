...
Característica: AT-DT005_Alta Duo por call center
  ...
  Esquema del escenario: Alta de dúo internet y añadir sva [deco smart] con CEX, en canal call center, web front end, flujo no biométrico
    ...
    Ejemplos:
      ...
      | usuario externo | evillanuevag | $Telefonica2020$ | Bienvenid@ | CAJAMARCA    | CE            | 1000000245 | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 460   | Casa       | Duo        | DÚO MOVISTAR VOZ INTERNET RA D22 100 MBPS |