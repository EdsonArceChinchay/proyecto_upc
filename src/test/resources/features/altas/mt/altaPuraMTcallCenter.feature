...
Característica: Alta Fija Pura MT por Call Center
  ...
  Esquema del escenario: Alta pura MT por call center con nuevo cliente con documento CE
    ...
    Ejemplos:
      ...
      | usuario externo | jpachaot | $t3l3f0n1c4$ | Bienvenid@ | CANAL ONLINE-CALL CENTER GSS | CE            | 100006666666 | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 460 | Inkafarma  | MOVISTAR TOTAL | 100 Mbps + 95 Gb | correo@gmail.com |
