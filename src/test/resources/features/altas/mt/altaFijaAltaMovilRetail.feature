...
Característica: AT-DT034_Alta Fija + Alta Movil por Retail
  ...
  Esquema del escenario: Alta fija mas alta movil Retail con Nuevo Cliente Extranjero
    ...
    Ejemplos:
      ...
      | usuario externo | evillanuevag | $t3l3f0n1c4$ | Bienvenid@ | CE            | 1000009112 | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 469 | Casa       | MOVISTAR TOTAL | HD 100 Mbps RA + 95 Gb RA |
