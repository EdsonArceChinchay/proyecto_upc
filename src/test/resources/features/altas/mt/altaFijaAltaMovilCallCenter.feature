...
Característica: Alta Fija + Alta Movil por Call Center
  ...
  Esquema del escenario: Alta fija mas alta movil por Call Center con DNI sin productos asociados y delivery express
    ...
    Ejemplos:
      ...
      | usuario externo | jpachaot    | $t3l3f0n1c4$   | Bienvenid@ |  CANAL ONLINE-CALL CENTER GSS    | DNI           | 43078337  | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 460   | Casa       | 500 Mbps + 95 Gb | CARMEN      | FRANCISCO   | SAN JUAN DE LURIGANCHO |
