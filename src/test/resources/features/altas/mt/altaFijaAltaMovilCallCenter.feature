...
#    Y        doy clic en finalizar registro
    ...
    Ejemplos:
      ...
      | usuario externo | jpachaot | $t3l3f0n1c4$ | Bienvenid@ | CANAL ONLINE-CALL CENTER GSS | DNI           | 71406727  | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 460 | Casa       | HD 500 Mbps + 95 Gb | HAYDEE      | EDGAR       | CHAUPIMARCA |
