...
Característica: Realizar una Alta movil Postpago (linea + equipo) con Delivery en Tambo
  ...
  Esquema del escenario: Alta movil Postpago por Call Center con DNI sin productos asociados sin biometria
	...
	Ejemplos:
      ...
      | usuario externo | jpachaot | $t3l3f0n1c4$ | Bienvenid@ | CANAL ONLINE-CALL CENTER GSS | CE            | 1000400045 | 15           | 1501      | 150136   | Calle Condesa de Chinchon 107 | Casa       | RV Plan Ilimitado Mi Movistar S/99.9 IV | Postpago  | Sin permanencia  | HUAWEI P30 LITE NEGRO MAR-LX3 | Financiado 12 cuotas |
#
