  ...
  Esquema del escenario: Alta movil Postpago por Call Center con DNI sin productos asociados sin biometria
   ...
   # Y        valido que se muestre el detalle del pedido
	Ejemplos:
      ...
      | usuario externo | jpachaot  | $t3l3f0n1c4$ | Bienvenid@ | Tiendas Franquicia Prueba    | CE            | 1000410045 | 15           | 1501      | 150136   | Calle Condesa de Chinchon 107 | Casa       | RV Plan Ilimitado Mi Movistar S/99.9 IV  | Postpago  | Sin permanencia  | BMOBILE AX1017 NEGRO | Financiado 12 cuotas |
#
