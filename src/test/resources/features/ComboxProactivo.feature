...
Característica: Alta Movil por Combo Proactivo
  ...
  Esquema del escenario: Alta  movil Combo Proactivo con Nuevo Cliente Extranjero
    ...
    Ejemplos:
      ...
      | usuario externo | vsiguass | $t3l3f0n1c4$ | Bienvenid@ | MOQUEGUA     | CE            | 1000000045 | RV Plan Ilimitado Movistar ilim S/69.9 | SAMSUNG GXY A11 AZUL 64GB SM-A115MZ | Postpago  | sin permanencia   | Financiado 12 cuotas |
