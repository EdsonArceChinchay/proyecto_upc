...
Característica: Alta Fija + Alta Movil por Retail
  ...
  @AltaFijaMovilRetail_CE
  Esquema del escenario: Alta fija mas alta movil Retail con Cliente Extranjero con productos asociados
...
#    Y        doy clic en confirmar
    ...
    Ejemplos:
      ...
      | usuario externo | vsiguass | $t3l3f0n1c4$ | Bienvenid@ | MOQUEGUA     | CE            | 1000000111 | 15           | 1501      | 150136   | Calle Condesa de Chinchon 107 | Casa       | MOVISTAR TOTAL | HD 100 Mbps + 26 Gb | correo@gmail.com |
