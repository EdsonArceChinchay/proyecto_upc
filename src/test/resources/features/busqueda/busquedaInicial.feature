...
#   Y        valido que se presente la tienda "<tiendaAsesor>"
    ...
    Ejemplos:
      ...
      | usuario externo | lterrazosce | $t3l3f0n1c4$ | Bienvenid@ | TIENDA SAN MIGUEL            | C             | 123456742 | Cuatro De Dos                   |
      ...
      | usuario externo | lterrazosce | $t3l3f0n1c4$ | Bienvenid@ | TIENDA SAN MIGUEL            | DNI           | 09822100  | GIOVANNA MARIBEL OCOLA ASENCIO  |
...
#      | usuario externo | lterrazosce  | Telefonica2021 | Bienvenid@ | CAJAMARCA                  | RUC           | 20450685446 | ANDEAN SOUTH EIRL          | 2   | CE              | 6172834231     |
      | usuario externo | vsiguass | $t3l3f0n1c4$ | Bienvenid@ | TALARA                       | RUC           | 20409258566 | INVERSIONES PAPER E.I.R.L. | 1   | DNI             | 75447441       |
