...
#    Y        valido que se presente la tienda "<tiendaAsesor>"
    ...
    Ejemplos:
      ...
      | usuario externo | evillanuevag | $Telefonica2020$ | Bienvenid@ | TIENDA SAN MIGUEL            | C             | 693459354 | -77.03839379  | -12.08616934  | JULIO CESAR TELLO 460    |
...
#    Y        valido que se presente la tienda "<tiendaAsesor>"
    ...
    Ejemplos:
      ...
      | usuario externo | evillanuevag | $Telefonica2020$ | Bienvenid@ | TIENDA SAN MIGUEL            | C             | 66783452374 | -77.03498486 | 0-           | LAS COORDENADAS SE ENCUENTRAN FUERA DEL RANGO DE COBERTURA            |
