...
#    Y        valido que se presente la tienda "<tiendaAsesor>"
    ...
    Ejemplos:
      ...
      | usuario externo | userNameCC | passCC | Bienvenid@ | CE            | 10000486488 | 15           | 1501      | 150136   | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRÍO MOV. VOZ INTERNET ESTANDAR RA 1D D22 50 MBPS | Plan Multidestino 20 | Bloque estelar | PACK ANTIVIRUS MCAFEE |