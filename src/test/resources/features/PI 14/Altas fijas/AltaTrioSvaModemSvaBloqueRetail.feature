...
#    Y        valido que se presente la tienda "<tiendaAsesor>"
	...
	Ejemplos:
	  ...
	  | usuario externo |  nishuizas| $t3l3f0n1c4$ | Bienvenid@ |  CE            | 10000646488 | 15           | 1501      | 150136   | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA  | Trio     | TRÍO MOV. VOZ INTERNET ESTANDAR RA 1D D22 50 MBPS | Bloque estelar  |