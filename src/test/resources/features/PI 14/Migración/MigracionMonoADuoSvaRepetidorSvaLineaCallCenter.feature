...
#	 Y        ingreso nuevamente el correo electronico "<correo>"
     ...
     Ejemplos:
       ...
       | usuario externo | jpachaot | $t3l3f0n1c4$ | Bienvenid@ | TIENDA SAN MIGUEL | CE            | 10021231242 | tester@tester.com | Duo           | DÚO MOVISTAR VOZ INTERNET RA D22 50 MBPS | Plan Multidestino 20 |