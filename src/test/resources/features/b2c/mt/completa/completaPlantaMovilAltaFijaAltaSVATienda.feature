...
Característica: AT-DT0 _Completa Fija MT (Planta Movil + Alta Fija) + SVA a cliente con CE por canal Tienda
  ...
  Esquema del escenario: Completa Fija MT (Planta Movil + Alta Fija) + SVA a cliente con CE por canal Tienda
    ...
    Ejemplos:
      | userType | userName   | userPassword   | msgHome    | insertarDireccion | channelType | documentType | documentNumber | nombrePlan | correo         |
      | userType | userNameST | userPasswordST | Bienvenid@ | SI                | Tienda      | CE           | 123456368      | Trío       | test@gmail.com |