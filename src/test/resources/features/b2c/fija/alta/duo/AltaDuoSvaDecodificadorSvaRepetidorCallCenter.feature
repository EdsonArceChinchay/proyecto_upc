...
Característica: AT-DT087_Alta Duo (Internet + TV) con SVA Decodificador + SVA Repetidor a cliente con CE por canal Call Center
  ...
  Esquema del escenario: Alta Duo con sva Decodificador + sva Repetidor CALL CENTER
    ...
    Ejemplos:
      ...
      | userType | userNameCC | userPasswordCC | Bienvenid@ | Call Center | CE           | 1042464815     | 15           | 1501      | 150136   | CALLE CONDESA DE CHINCHON 107 | AL FRENTE DE LA BOTICA | Duo      | DÚO INTERNET FLEX HD RA | PUNTO ADICIONAL HD | Repetidor WIFI PLUS Venta |