...
#    Y        doy click en el boton confirmar
    ...
    Ejemplos:
      ...
      | userType | userNameQAN1 | userPasswordQAN1 | Bienvenid@ | Call Center | CE           | 1100002107     | LIMA         | LIMA      | LINCE    | JIRON JULIO CESAR TELLO 469 | Casa       | Duo        | DUO MOVISTAR VOZ INTERNET |