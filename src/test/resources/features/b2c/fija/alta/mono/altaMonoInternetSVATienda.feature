...
Característica: AT-DT008_Alta Fija Internet + SVA a cliente con CE por canal Tienda
  ...
  Esquema del escenario: Alta fija por canal Tienda con CE sin productos asociados sin biometria
    ...
    Ejemplos:
      ...
      | userType | userNameST | userPasswordST | Bienvenid@ | SI                | Tienda      | CE           | 1100000494     | LIMA         | LIMA      | LINCE    | JIRON JULIO CESAR TELLO 469 | INKAFARMA  | Mono     | INTERNET MOVISTAR RA | PACK ANTIVIRUS MCAFEE |
