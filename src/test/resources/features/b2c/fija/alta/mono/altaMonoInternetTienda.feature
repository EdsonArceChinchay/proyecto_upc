...
Característica: AT-DT009_Alta fija mono Internet a cliente con CE por canal Tienda
  ...
  Esquema del escenario: Alta fija a cliente con CE por canal Tienda
    ...
    Ejemplos:
      ...
      | userType | userNameST | userPasswordST | Bienvenid@ | SI                | Tienda      | CE           | 1423432127     | LIMA         | LIMA      | LINCE    | JR JULIO CESAR TELLO 469 UR RISSO | INKAFARMA  | Mono     | INTERNET MOVISTAR |
