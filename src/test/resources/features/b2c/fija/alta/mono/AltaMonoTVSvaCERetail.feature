...
Característica: AT-DT092_Alta Mono TV + SVA a cliente con CE por canal Retail
  ...
  Esquema del escenario: Alta Mono TV + SVA a cliente con CE por canal Retail
    ...
    Y        ingreso correo electronico "tester48582q@tester.com"
    ...
    Ejemplos:
      ...
      | userType | userNameST | userPasswordST | Bienvenid@ | SI                | Tienda      | CE           | 1000002848     | LIMA         | LIMA      | SAN MIGUEL | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Mono     | TV         | bloque |