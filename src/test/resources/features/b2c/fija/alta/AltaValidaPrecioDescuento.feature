...
Característica: Validar precio de descuento BB - Planes: Duos, trios.
  ...
  #  Y        doy click en el boton Guardar cambios
    ...
    Ejemplos:
      ...
      | externalUser | userNameCC | userPasswordCC | Bienvenid@ | Call Center | CE           | 1022233168     | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 469 | Casa       | Duo        | DUO INTERNET FLEX HD RA S23 600 MBPS           | Combo Plus Bonif TV | 300 Mbps    | Descto Plan Internet 50% x 2 ms | HBO    | Duo      | PACK ANTIVIRUS MCAFEE | HBO    |
