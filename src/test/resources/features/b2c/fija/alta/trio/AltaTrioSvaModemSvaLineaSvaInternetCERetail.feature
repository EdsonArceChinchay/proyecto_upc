...
Característica: AT-DT0_Alta Trio con sva Modem + sva Linea + sva Internet por canal Retail
  ...
  Esquema del escenario: Alta Trio con sva Modem + sva Linea + sva Internet por canal Retail
    ...
    Ejemplos:
      ...
      | userType | userNameDLC | userPasswordDLC | Bienvenid@ | SI                | Retail      | CE           | 1059122148     | LIMA         | LIMA      | SAN MIGUEL | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | Plan Multidestino  20 | PACK ANTIVIRUS MCAFEE |