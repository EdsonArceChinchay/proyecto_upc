...
Característica: Alta Trio con sva Decodificador + sva linea Canal Call Center
  ...
  Esquema del escenario: Alta Trio con sva Decodificador + sva linea Canal Call Center
    ...
    Y        ingreso correo electronico "tester_12.1@tester.com"
    ...
    Ejemplos:
      ...
      | externalUser | userNameCC | userPasswordCC | Bienvenid@ | Call Center | CE           | 1066122148     | 15           | 1501      | 150136   | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | 9.90          | Plan Multidestino  20 |