...
Característica: AT-DT0_Alta Trio con sva Repetidor + sva Modem por canal Call Center

  @AltaTrioSvaRepetidorSvaModemCallCenter
  Esquema del escenario: Alta Trio con sva Repetidor + sva Modem por canal Call Center
    ...
    Y        ingreso correo electronico "tester_1_2@tester.com"
    ...
    Ejemplos:
      | userType | userName   | userPassword   | msgHome    | insertarDireccion | channelType | documentType | documentNumber | departamento | provincia | distrito   | direccion            | referencia             | tipoPlan | nombrePlan                  | svaRepetidor              |
      | userType | userNameCC | userPasswordCC | Bienvenid@ | SI               | Call Center | CE           | 1067122148     | LIMA         | LIMA      | SAN MIGUEL | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | Repetidor WIFI PLUS Venta |