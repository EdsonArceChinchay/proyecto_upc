...
Característica: AT-DT0_Alta Trio con sva Internet por canal Retail
  ...
  Esquema del escenario: Alta Trio con sva Internet CANAL Retail
    ...
    Ejemplos:
      ...
      | userType | userNameDLC | userPasswordDLC | Bienvenid@ | SI                | Retail      | CE           | 1000024488     | LIMA         | LIMA      | SAN MIGUEL | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | PACK ANTIVIRUS MCAFEE | Bloque |