...
Característica: AT-DT003_Alta Trio a cliente con CE por Canal Retail
  ...
  Esquema del escenario: Alta Trio a cliente con CE por Canal Retail
    ...
    Y        selecciono el departamento donde sera la installation "<departamento>"
    ...
    Ejemplos:
      ...
      | externalUser | userNameDLC | userPasswordDLC | Bienvenid@ | Retail      | CE           | 1042464816     | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 469 | casa crema | Trío     | TRIO MOV. VOZ INT. ESTANDAR |
