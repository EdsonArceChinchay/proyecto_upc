...
Característica: Alta Trio + SVA a cliente con CE por Canal Retail
  ...
  Esquema del escenario: Alta Trio SVA canal Retail
    ...
    Ejemplos:
      ...
      | externalUser | userNameDLC | userPasswordDLC | Bienvenid@ | Retail      | CE           | 1042411002     | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 469 | INKAFARMA  | Trío     | TRÍO MOVISTAR VOZ INTERNET ESTANDAR | PACK ANTIVIRUS MCAFEE |