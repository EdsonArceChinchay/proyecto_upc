...
Característica: Alta Trio con sva Modem + sva Bloque Canal Retail
  ...
  Esquema del escenario: Alta Trio con sva Modem + sva Bloque Canal Retail
    ...
    Ejemplos:
      ...
      | externalUser | userNameDLC | userPasswordDLC | Bienvenid@ | Retail      | CE           | 1061122148     | 15           | 1501      | 150136   | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | Bloque |