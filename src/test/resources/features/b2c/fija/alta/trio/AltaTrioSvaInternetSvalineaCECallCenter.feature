...
Característica: AT-DT0_Alta Trio con SVA Internet + SVA Linea por canal Call Center
  ...
  Esquema del escenario: Alta Trio con sva Internet + sva linea CANAL CALL CENTER
    ...
    Ejemplos:
      | userType | userName   | userPassword   | msgHome    | insertarDireccion | channelType | documentType | documentNumber | departamento | provincia | distrito   | direccion            | referencia             | tipoPlan | nombrePlan                  | svaLinea             | svaInternet           |
      | userType | userNameCC | userPasswordCC | Bienvenid@ | SI                | Call Center | CE           | 162122148      | LIMA         | LIMA      | SAN MIGUEL | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | Plan Multidestino 20 | PACK ANTIVIRUS MCAFEE |