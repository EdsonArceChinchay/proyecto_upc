...
Característica: Alta Trio con SVA Internet + SVA Linea por canal Call Center
  ...
  Esquema del escenario: Alta Trio con sva Internet + sva linea CANAL CALL CENTER
    ...
    Ejemplos:
      | tipoUsuario     | userName   | password | msgHome    | channelType | tipoDocumento | documento  | departamento | provincia | distrito | direccion            | referencia             | tipoPlan | nombrePlan                  | svaLinea             | svaInternet           |
      | usuario externo | userNameCC | passCC   | Bienvenid@ | Call Center | CE            | 1062122148 | 15           | 1501      | 150136   | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | Plan Multidestino 20 | PACK ANTIVIRUS MCAFEE |