...
Característica: Validar Combo Plus Bonif TV - Planes: Monos, Dúos y Trios
  ...
  #  Y        doy click en el boton Guardar cambios
    ...
    Ejemplos:
      ...
      | userType | userNameCC | userPasswordCC | Bienvenid@ | Call Center | CE           | 1029045634     | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 469 | Casa       | Duo        | DUO MOVISTAR VOZ ESTÁNDAR HD RA M23            | Combo Plus Bonif TV | 200 Mbps    | Descuento Prom Internet S/40 x 1m | HBO    | Duo      | PACK ANTIVIRUS MCAFEE | HBO    |
