...
Característica: AT-DT_Porta Directa solo chip postpago a cliente con DNI en canal Call Center

  @PortaDirectaPostCC
  Esquema del escenario: Porta Directa solo chip postpago a cliente con DNI en canal Call Center
    ...
    Ejemplos:
      ...
      | usuario externo | userNameCC | passCC   | Bienvenid@ | Call Center | DNI           | 42565073  | 920956351 | Postpago  | OPERADOR DE PRUEBA | Postpago      | RV Plan Ilimitado Mi Movistar | ERMINIA     | APOLONIO    | LURIN       |
