...
Característica: Realizar CAPL de prepago a postpago con equipo
  ...
  Esquema del escenario: CAPL de prepago a postpago por canal CALLCENTER
    ...
    Y        ingreso el documento "1042465056"
    ...
    Ejemplos:
      | tipoUsuario     | userName | password     | msgHome
      | usuario externo | jpachaot | $t3l3f0n1c4$ | Bienvenid@