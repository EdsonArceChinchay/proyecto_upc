...
@BERSERKERS @DoneDevOps @DoneDevOpsPI11SP5
  Característica: Realizar un CAPL con Caeq al contado con canal Tienda de un Control a prepago

    @CaplConCaeqPorTiendaControlAPrepago
    Escenario: CAPL con Caeq al contado con canal Tienda de un Control a prepago exitoso
      ...
      Y        selecciono el tipo "Prepago"
      Y        selecciono el plan "Preplan" y presiono Seleccionar Oferta
      Y        valido que se haya seleccionado el plan "Preplan" correctamente
