...
Característica: Alta Fija migracion deco HD a Smart HD
  ...
  Esquema del escenario: alta Fija migracion deco HD a Smart HD
	...
	Ejemplos:
	  ...
	  | usuario externo | vsiguass | $t3l3f0n1c4$ | Bienvenid@ | CANAL ONLINE-CALL CENTER GSS | CE            | 102313480 | correo@gmail.com | discapacitado  | MARIBEL     | JOSE        | SULLANA     | Trío          | Trío Movistar Voz Internet Estandar HD RA 100 Mbps |
