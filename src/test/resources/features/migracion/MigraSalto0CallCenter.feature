...
Característica: Migracion salto 0 canal Call Center
  ...
  Esquema del escenario: Migracion salto 0 con CE  por canal Call Center
    ...
    Ejemplos:
      ...
      | usuario externo | jpachaot | $t3l3f0n1c4$ | Bienvenid@ | CE            | 7241133112 | correo@gmail.com | discapacitado  | MARIBEL     | JOSE        | SULLANA     | Trío          | Trío Movistar Voz Internet Estandar HD RA 100 Mbps |
