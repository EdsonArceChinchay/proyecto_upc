#language:es
@BERSERKERS @DoneDevOps @DoneDevOpsPI11 @AT-DT082
...
Característica: Migracion de Trio a trio  por el canal Call Center
  ...
  Esquema del escenario: Migracion de Trio a trio
	...
	Ejemplos:
	  ...
	  | usuario externo | jpachaot | $t3l3f0n1c4$ | Bienvenid@ | TIENDA SAN MIGUEL | CE            | 1042464993 | tester@tester.com | Trío          | Trío Movistar Voz Internet Estandar HD RA 100 Mbps | PACK ANTIVIRUS MCAFEE |