   ...
   # Y        doy click en agregar "<sva>"
    ...
    Ejemplos:
     ...
     # | usuario externo | jpachaot | $t3l3f0n1c4$ | Bienvenid@  | RUC            | 20513763663  |1   |DNI            |75448228 | tester@tester.com | TRIO           | RA D22 50 MBPS | Plan Multidestino 20 |
      | usuario externo | jpachaot | $t3l3f0n1c4$ | Bienvenid@ | RUC           | 20100323002 | 1   | DNI             | 75447576       | tester@tester.com | TRIO          | HD RA D22 50 MBPS | Plan Multidestino 20 | Validación biométrica |
