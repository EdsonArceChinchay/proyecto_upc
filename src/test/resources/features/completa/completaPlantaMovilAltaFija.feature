...
#    Y        busco por el documento
    ...
    Ejemplos:
      | tipoUsuario     | userName | password     | msgHome    | nombreCliente             | tipoDocumento   | documento  | departamento | provincia | distrito | direccion                         | referencia                        | tipoOferta     | nombrePlan                                | correo                                   |
