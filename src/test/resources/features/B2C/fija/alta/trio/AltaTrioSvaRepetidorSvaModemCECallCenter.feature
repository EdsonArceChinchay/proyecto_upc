...
Característica: Alta Trio con sva Repetidor + sva Modem Canal Call Center
  ...
  Esquema del escenario: Alta Trio con sva Repetidor + sva Modem Canal Call Center
    ...
    Ejemplos:
      | tipoUsuario     | userName   | password | msgHome    | channelType | tipoDocumento | documento  | departamento | provincia | distrito | direccion            | referencia             | tipoPlan | nombrePlan                  | svaRepetidor              |
      | usuario externo | userNameCC | passCC   | Bienvenid@ | Call Center | CE            | 1067122148 | 15           | 1501      | 150136   | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | Repetidor WIFI PLUS Venta |