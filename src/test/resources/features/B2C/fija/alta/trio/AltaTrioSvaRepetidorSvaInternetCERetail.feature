...
Característica: Alta Trio con sva Internet por canal Retail
  ...
  Esquema del escenario: Alta Trio con sva Internet CANAL Retail
    ...
    Ejemplos:
      ...
      | usuario externo | userNameDLC | passDLC  | Bienvenid@ | Retail      | CE            | 1000024488 | 15           | 1501      | 150136   | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | PACK ANTIVIRUS MCAFEE | Bloque estelar |