...
Característica: Alta Trio con SVA Internet por Canal Retail
  ...
  Esquema del escenario: Alta Trio con SVA Internet "<svaInternet>" por Canal Retail
    ...
    Ejemplos:
      ...
      | usuario externo | userNameDLC | passDLC  | Bienvenid@ | Retail      | CE            | 10000024488 | 15           | 1501      | 150136   | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | PACK ANTIVIRUS MCAFEE | Bloque estelar |