...
Característica: Alta Trio con sva Modem + sva Linea Canal Retail
  ...
  Esquema del escenario: Alta Trio con sva Modem + sva Linea Canal Retail
    ...
    Ejemplos:
      ...
      | usuario externo | userNameDLC | passDLC  | Bienvenid@ | Retail      | CE            | 1065122148 | 15           | 1501      | 150136   | CALLE SAN MARTIN 399 | AL FRENTE DE LA BOTICA | Trio     | TRIO MOV. VOZ INT. ESTANDAR | Plan Multidestino  20 |