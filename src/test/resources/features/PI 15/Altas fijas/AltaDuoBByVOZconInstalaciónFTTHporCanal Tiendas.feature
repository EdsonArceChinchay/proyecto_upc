...
Antecedentes:
  ...
  Esquema del escenario: Alta Duo SVA HBO CALL CENTER
	...
	Ejemplos:
	  ...
	  | usuario externo | evillanuevag | $Telefonica2099% |Bienvenid@ | TIENDA SAN MIGUEL | CE            | 1234539137  | 15           | 1501      | 150116   | JIRON JULIO CESAR TELLO 460 | Casa       | Duo      | DUO MOVISTAR VOZ INTERNET RA M23 100 MBPS